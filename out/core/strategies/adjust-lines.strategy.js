...
exports.AdjustLinesStrategy = void 0;
 ...
 * ```
 */
class AdjustLinesStrategy extends file_processing_strategy_1.BaseFileProcessingStrategy {
    getName() {
     ...
     */
    needsAdjustment(content) {
        const analysis = this.analyzeEmptyLines(content);
        return analysis.linesToBeRemoved > 0;
    }
}
exports.AdjustLinesStrategy = AdjustLinesStrategy;
//# sourceMappingURL=adjust-lines.strategy.js.map