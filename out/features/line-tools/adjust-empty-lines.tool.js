...
exports.AdjustEmptyLinesTool = void 0;
const tool_interface_1 = require("../../core/interfaces/tool.interface");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class AdjustEmptyLinesTool {
    constructor() {
        this.id = 'adjust-empty-lines';
        this.name = 'Ajustar Linhas Vazias';
        this.description = 'Remove linhas vazias excedentes (mantém 1 entre blocos)';
        this.icon = '🪄';
...
exports.AdjustEmptyLinesTool = AdjustEmptyLinesTool;
//# sourceMappingURL=adjust-empty-lines.tool.js.map