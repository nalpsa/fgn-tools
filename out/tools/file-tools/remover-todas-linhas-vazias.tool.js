 ...
 */
class RemoverTodasLinhasVaziasTool {
    constructor() {
        this.id = 'remover-todas-linhas-vazias';
        this.name = 'Remover TODAS as Linhas Vazias';
        this.description = 'Remove TODAS as linhas vazias dos arquivos selecionados';
        this.icon = 'clear-all';
    ...
    openUI() {
        ...
        this.panel = vscode.window.createWebviewPanel('removerTodasLinhasVazias', '🗑️ Remover TODAS as Linhas Vazias', vscode.ViewColumn.Two, {
            enableScripts: true,
