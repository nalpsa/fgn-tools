...
exports.ContadorTextoTool = void 0;
...
class ContadorTextoTool {
    ...
    openUI() {
        ...
        this.panel = vscode.window.createWebviewPanel('contadorTexto', '📊 Contador de Texto', vscode.ViewColumn.Two, {
            enableScripts: true,
...
exports.ContadorTextoTool = ContadorTextoTool;
//# sourceMappingURL=contador-texto.tool.js.map