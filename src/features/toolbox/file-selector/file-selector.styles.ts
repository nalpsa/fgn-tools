 ...
 */
export class FileSelectorStyles {
    ...
    private getInfoBoxStyles(): string {
        return `
        .info-box {
    ...
    private getWarningBoxStyles(): string {
        return `
        .warning-box {
    ...
    private getFileExplorerStyles(): string {
        return `
        .file-explorer {
    ...
    private getStatisticsStyles(): string {
        return `
        .statistics {
            margin: 15px 0;
            padding: 12px;
    ...
    private getResultsStyles(): string {
        return `
        .results {
            margin-top: 20px;
            padding: 15px;
